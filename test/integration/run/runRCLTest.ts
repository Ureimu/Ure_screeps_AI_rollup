...
// storage.db["rooms.objects"].update({ room: "W8N3", type: "rampart" }, { $set: { hits: 3000000 } })

// storage.db["rooms.objects"].update({ room: "W8N3", type: "constructedWall" }, { $set: { hits: 3000000 } })
