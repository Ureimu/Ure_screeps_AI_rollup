...
storage.db["rooms.objects"].update({ room: "W8N7", type: "storage" }, { $set: { store: { energy: 950000 } } })
...
storage.db["rooms.objects"].update({ _id: "1039077215080e1" },{ $set: { level: 4, progress: 1 } })
